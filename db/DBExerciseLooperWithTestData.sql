...
CREATE TABLE IF NOT EXISTS `ExerciseLoop`.`exercises` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Question_status_idx` (`states_id` ASC) VISIBLE,
...
VALUES ("Building"),("Answering"),("Closed");

INSERT INTO types(name)
VALUES ("Single line text"),("List of single lines"),("Multi-line text");

INSERT INTO exercises(title, states_id)
VALUES ("Exercise 1",1),("Exercise 2",1),("Exercise 3",2),("Exercise 4",2), ("Exercise 5",3);

INSERT INTO questions(question,exercise_id,types_id)
